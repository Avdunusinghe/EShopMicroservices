...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Ashen", "avdunusinghe@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Erandika", "erandika1986@gmail.com")
    };
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Ashen", "Dunusinghe", "avdunusinghe@gmail.com", "23", "Biyagama", "Delgoda", "11700");
            var address2 = Address.Of("Erandika", "Dunusinghe", "erandika1986@gmail.com", "23", "Biyagama", "Delgoda", "11700");

            var payment1 = Payment.Of("ashen", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("Erandika", "8885555555554444", "06/30", "222", 2);
